/**
 * A custom serializer used to serialize a {@link ProjectInfo} object into a json string.
 *
 * @author mhooda
 */
...
public class ProjectInfoSerializer extends StdSerializer implements ResolvableSerializer {
     ...
     *         The json object path to used generate to nested the {@link ProjectInfo} object.
     */
    public ProjectInfoSerializer(JsonFactory jsonFactory, JsonSerializer<Object> defaultJsonSerializer, String[] modelTraversalPath) {
     ...
     */
    @Override
    public void serialize(Object ProjectInfo, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        JsonGenerator tempGenerator = jsonFactory.createGenerator(new ByteArrayOutputStream());

        // Use the default Jackson serializer
        defaultJsonSerializer.serialize(ProjectInfo, tempGenerator, serializerProvider);
